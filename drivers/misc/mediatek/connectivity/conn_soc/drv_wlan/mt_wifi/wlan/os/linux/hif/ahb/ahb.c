...
/*----------------------------------------------------------------------------*/
BOOLEAN
kalDevPortRead(IN GLUE_INFO_T *GlueInfo, IN UINT_16 Port, IN UINT_16 Size, OUT PUINT_8 Buf, IN UINT_16 MaxBufSize)
{
	GL_HIF_INFO_T *HifInfo;
#if (CONF_MTK_AHB_DMA == 1)
...
/*----------------------------------------------------------------------------*/
BOOLEAN
kalDevPortWrite(IN GLUE_INFO_T *GlueInfo, IN UINT_16 Port, IN UINT_16 Size, IN PUINT_8 Buf, IN UINT_16 MaxBufSize)
{
	GL_HIF_INFO_T *HifInfo;
#if (CONF_MTK_AHB_DMA == 1)
	MTK_WCN_HIF_DMA_CONF DmaConf;
